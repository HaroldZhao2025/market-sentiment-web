    ...
    <div className="mx-auto max-w-6xl px-4 py-8 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="rounded-2xl p-5 shadow-sm border bg-white">
          ...
          <div className="text-2xl md:text-3xl font-semibold">{(lastMA * 100).toFixed(4)}%</div>
        </div>
        <div className="rounded-2xl p-5 shadow-sm border bg-white">
        ...
        <div className="rounded-2xl p-5 shadow-sm border bg-white">
          ...
          <div className="text-2xl md:text-3xl font-semibold">{newsTotal.toLocaleString()}</div>
        </div>
      </div>
