...
function dateOnly(s: string): string {
  // keep YYYY-MM-DD when present; else try Date parse, else first token
  ...
  return (
    <div style={{ border: "1px solid #e5e7eb", borderRadius: 12, padding: 12 }}>
      ...
      <svg
        ...
        role="img"
        aria-label="Sentiment and price chart"
      >
        {/* sentiment baseline */}
        {showSent && (
          <line
      ...
      <div style={{ marginTop: 8, fontSize: 14, color: "#4b5563" }}>
        {hoverI != null ? (
          <>
            ...
            {showSent && (
              <>
                <b>Sentiment:</b> {series.sentiment[hoverI].toFixed(2)} &nbsp; | &nbsp;
              </>
            )}
            {showPrice && (
              <>
...
export default function TickerClient({
  ...
  return (
    <div style={{ display: "grid", gap: 16 }}>
      {/* segmented control: Overlay / Price Only / Sentiment Only */}
